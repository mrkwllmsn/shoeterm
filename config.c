...
add_default_key_bindings(struct config *conf)
{
    const struct config_key_binding bindings[] = {
        ...
        {BIND_ACTION_CROSSHAIR, m(XKB_MOD_NAME_CTRL "+" XKB_MOD_NAME_SHIFT), {{XKB_KEY_i}}},
        {BIND_ACTION_CROSSHAIR_FIX_POSITION, m(XKB_MOD_NAME_CTRL "+" XKB_MOD_NAME_SHIFT), {{XKB_KEY_f}}},
        {BIND_ACTION_CROSSHAIR_MOUSE_POSITION, m(XKB_MOD_NAME_CTRL "+" XKB_MOD_NAME_SHIFT), {{XKB_KEY_m}}},
        {BIND_ACTION_CROSSHAIR_PIXEL_POSITION, m(XKB_MOD_NAME_CTRL "+" XKB_MOD_NAME_SHIFT), {{XKB_KEY_p}}},
        {BIND_ACTION_CROSSHAIR_STYLE, m(XKB_MOD_NAME_CTRL "+" XKB_MOD_NAME_SHIFT), {{XKB_KEY_s}}},
